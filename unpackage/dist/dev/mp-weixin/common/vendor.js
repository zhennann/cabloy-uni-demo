...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"cabloy-uni-demo","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 4 */
/*!*****************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/pages.json ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 11 */
/*!********************************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/js_sdk/cabloy-sdk/main.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var Util = __webpack_require__(/*! ./util.js */ 12);
var Api = __webpack_require__(/*! ./api.js */ 13);
var Data = __webpack_require__(/*! ./data.js */ 14);
var Config = __webpack_require__(/*! ./config.js */ 15);
...
/* 12 */
/*!********************************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/js_sdk/cabloy-sdk/util.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = function (cabloy) {
  return {
    preferredLocale: function preferredLocale(locale) {
      ...
      return Object.keys(locales).find(function (item) {return item.indexOf(localeShort) === 0;});
    },
    ...
    __login_wechat: function __login_wechat(options) {var _this = this;
      return new Promise(function (resolve, reject) {
        var scene = cabloy.config.base.scene;
        if (options && options.detail) {
          // 直接进行后台登录
          _this.__login({ scene: scene, code: null, detail: options.detail }).then(resolve).catch(reject);
        } else {
          // 小程序登录
          wx.login({
                  ...
                  if (res.authSetting['scope.userInfo']) {
                    ...
                    wx.getUserInfo({
                      success: function success(detail) {
                        // 后台登录
                        _this.__login({ scene: scene, code: code, detail: detail }).then(resolve).catch(reject);
                      } });

                  } else {
                    // 虽然没有userInfo，但有openid，仍然可以进行后台登录
                    _this.__login({ scene: scene, code: code, detail: null }).then(resolve).catch(reject);
                  }
                } });
    ...
    __login_wxwork: function __login_wxwork(options) {var _this2 = this;
      return new Promise(function (resolve, reject) {
        // 小程序登录
        wx.qy.login({
          success: function success(res) {
            var scene = cabloy.config.base.scene;
            var code = res.code;
            _this2.__login({ scene: scene, code: code }).then(resolve).catch(reject);
          } });

      });
    },

    __login_dingtalk: function __login_dingtalk(options) {var _this3 = this;
      return new Promise(function (resolve, reject) {
        // 小程序登录
        dd.getAuthCode({
          success: function success(res) {
            ...
            _this3.__login({ scene: scene, code: code }).then(resolve).catch(reject);
          } });

      });
    },

    __login: function __login(_ref) {var scene = _ref.scene,code = _ref.code,detail = _ref.detail;
      // 后台登录
      var url = "/a/".concat(cabloy.data.container, "/authMini/login?locale=").concat(cabloy.data.locale);
      return cabloy.api.post(url, { scene: scene, code: code, detail: detail }).then(function (data) {
        // user
    ...
    extend: function extend() {
      var deep = true;
      var to;
      var from;for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
...
/* 13 */
/*!*******************************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/js_sdk/cabloy-sdk/api.js ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 14 */
/*!********************************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/js_sdk/cabloy-sdk/data.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 15 */
/*!**********************************************************************************************!*\
  !*** /Users/yangjian/Documents/HBuilderProjects/cabloy-uni-demo/js_sdk/cabloy-sdk/config.js ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
